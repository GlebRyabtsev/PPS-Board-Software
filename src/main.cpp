...
#define _SERIAL_CONNECTION_REQUEST_CMD 0x00
#define _SERIAL_SET_VOLTAGE_REQUEST_CMD 0X01
#define _SERIAL_READ_VOLTAGE_REQUEST_CMD 0x02
#define _SERIAL_READ_CURRENT_REQUEST_CMD 0x03
...
void process_serial_request() {
  ...
  switch (cmd) {
    case _SERIAL_CONNECTION_REQUEST_CMD:
      handle_connection_request();
      break;
    case _SERIAL_SET_VOLTAGE_REQUEST_CMD:
      handle_set_voltage_request();
      break;
    case _SERIAL_READ_VOLTAGE_REQUEST_CMD:
      handle_read_voltage_request();
      break;
    case _SERIAL_READ_CURRENT_REQUEST_CMD:
